...
| :--- | :--- |
| **Mobile Development** | Flutter, Dart, Android Native (Java/Kotlin), FlutterFlow |
| **Automation & Low-Code** | n8n, Workflow Automation, AI Integration, Python |
| **Architectures & Patterns** | Clean Architecture, MVVM, Bloc, GetX, OOP |
| **Backend & Databases** | Firebase, Supabase, MongoDB, SQL, RESTful APIs |
| **Engineering Core** | Git, Logic Design, Problem Solving (LeetCode/ICPC) |
...
* **Élan Hotel** | *FlutterFlow, n8n, MongoDB*
    * Smart hotel services integrated with automated backend workflows.
* **Career App** | *Flutter, GetX, Firebase*
    * Scalable marketplace solution with a focus on robust architecture.
