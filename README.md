...
* Implemented efficient **State Management** (GetX/Bloc) to improve UI performance.
* Managed cloud backend services and secure authentication workflows.

#### **Programming Instructor** | **BareeQ Academy & DECI**
* Educated children on programming fundamentals and algorithmic logic.
* Instructor for the **Digital Egypt Cubs Initiative (DECI)**, delivering coding curricula.
* Simplified complex technical concepts to foster creative problem-solving skills.
...
<p align="left">
  ...
  &nbsp;
  <a href="https://github.com/GhadaAhmed152420" target="_blank">
